...
const components: Components = {
  ...
  ul: ({ className, ...props }) => (
    <ul
      className={cn(
        "my-2 list-disc space-y-0.5 pl-5 first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  ol: ({ className, ...props }) => (
    <ol
      className={cn(
        "my-2 list-decimal space-y-0.5 pl-5 first:mt-0 last:mb-0",
        className,
      )}
      {...props}
    />
  ...
  th: ({ className, ...props }) => (
    <th
      className={cn(
        "whitespace-nowrap px-2 py-1 text-left font-medium",
        className,
      )}
      {...props}
    />
