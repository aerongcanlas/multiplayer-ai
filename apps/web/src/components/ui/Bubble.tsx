    ...
    "group/bubble relative flex w-fit max-w-[80%] min-w-0 flex-col gap-1 group-data-[align=end]/message:self-end data-[align=end]:self-end data-[variant=ghost]:max-w-full",
    {
        variants: {
            variant: {
                ...
                own: "*:data-[slot=bubble-content]:bg-message-own *:data-[slot=bubble-content]:text-message-own-foreground",
                other: "*:data-[slot=bubble-content]:bg-message-other *:data-[slot=bubble-content]:text-message-other-foreground",
            },
        },
        defaultVariants: {
            variant: "default",
